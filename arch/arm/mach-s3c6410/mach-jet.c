...
static int instinctq_gpio_table[][6] = {
	...
	/* GPE */
	{ GPIO_VT_PCM_CLK, 	0, 			GPIO_LEVEL_NONE, 	S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_WLAN_WAKE,	GPIO_WLAN_WAKE_AF, 	GPIO_LEVEL_LOW, 	S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_VT_PCM_SYNC,	0, 			GPIO_LEVEL_NONE, 	S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_VT_PCM_IN, 	0, 			GPIO_LEVEL_NONE, 	S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	{ GPIO_VT_PCM_OUT, 	0, 			GPIO_LEVEL_NONE, 	S3C_GPIO_PULL_DOWN, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN },
	/* GPF */
...
*/
	...
	{ GPIO_USBSW_SCL_3V0, 	GPIO_USBSW_SCL_3V0_AF,	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_USBSW_SDA_3V0, 	GPIO_USBSW_SDA_3V0_AF,	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
/*
...
//	{ GPIO_WLAN_HOST_WAKE, GPIO_WLAN_HOST_WAKE_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, 0, 0 },
	...
	{ GPIO_FM_LDO_ON, 	GPIO_FM_LDO_ON_AF,	GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_POWER_N, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
//	{ GPIO_PHONE_ON, 	GPIO_PHONE_ON_AF, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_PHONE_ACTIVE, 	GPIO_PHONE_ACTIVE_AF, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_PWR_I2C_SCL, 	GPIO_PWR_I2C_SCL_AF, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	{ GPIO_PWR_I2C_SDA, 	GPIO_PWR_I2C_SDA_AF, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE },
	...
	/* GPO */
	{ GPIO_CP_BOOT_SEL, 	0, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP, 0, 0 },
...
//	{ GPIO_PDA_ACTIVE, GPIO_PDA_ACTIVE_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 }, 
	...
	/* GPN */
	{ GPIO_FM_LDO_ON, 	0, 			GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, 0, 0 },
//	{ GPIO_PHONE_ON, 	0, 			GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN, 0, 0 },
//	{ GPIO_PWR_I2C_SCL, 	0, 			GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
//	{ GPIO_PWR_I2C_SDA, 	0, 			GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
...
//	{ GPIO_AP_SCL_1V8, 	0, 			GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
//	{ GPIO_AP_SDA_1V8, 	0, 			GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
	{ GPIO_LCD_RST_N, 	GPIO_LCD_RST_N_AF, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
	{ GPIO_LCD_DET, 	GPIO_LCD_DET_AF, 	GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
